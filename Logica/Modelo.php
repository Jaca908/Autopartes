...
function GuardarOModificar()//funcion para guardar o modificar un modelo
{
...
function Consultar()//funcion para consultar un modelo antes de modificar o solo ver
{
	$Codigo=$_POST['Codigo'];
