...
function GuardarOModificar()//funcion para guardar o modificar un subgrupo
{
...
function Consultar()//funcion para consultar un subgrupo antes de modificar o solo ver
{
	$Codigo=$_POST['Codigo'];
	//$FK_Usuario=$_SESSION['IDUsuario'];
