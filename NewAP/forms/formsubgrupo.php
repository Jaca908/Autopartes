		...
		<div class="overflow-container">
			...
			<ul class="menu-dropdown">
				...
				<li class="menu-hasdropdown">
					...
					<ul class="sub-menu-dropdown">
						<li><a href="#">Ingresar SubGrupo</a></li>
...
<div class="container">
  <form action="/action_page.php">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="firstname" placeholder="Ingrese el codigo de subGrupo..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="Ingrese el nombre del SubGrupo..">
      </div>
    </div>
   <!-- <div class="row">
      <div class="col-25">
