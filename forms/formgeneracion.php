...
<div class="container">
  <form action="/action_page.php">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="firstname" placeholder="Ingrese el codigo de generacion..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="lname">Generacion</label>
      </div>
      <div class="col-75">
        <input type="text" id="lname" name="lastname" placeholder="Ingrese el nombre de la generacion..">
      </div>
    </div>
   <!-- <div class="row">
      <div class="col-25">
